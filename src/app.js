...
app.get(`/bingoChange`, isLoggedIn, (request, response, next) => {
                        ...
                        .then((data) =>{
                            ...
                            if (!isGame) {
                                db.query(`insert into bingoschema.games (id, players, bingo_id) values ('${gameCode}', '{${session.nickname}}', ${bingo_id})`)
                                    ...
                                    .catch((error)=>{
                                        console.log(`insert into bingoschema.games (id, players, bingo_id) values ('${gameCode}', '{${session.nickname}}', ${bingo_id})` + error)
                                    })
                            } else {
...
app.get(`/createBingo`, isLoggedIn, (request, response, next) => {
